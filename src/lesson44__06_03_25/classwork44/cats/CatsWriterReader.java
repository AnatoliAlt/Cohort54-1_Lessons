...
public class CatsWriterReader {
    public static void main(String[] args) {
        List<Cat> cats = new ArrayList<>(List.of( // Создаем список (массив) кошек
                new Cat("Cat", 9, true),
                new Cat("John", 2, true),
        ...
        path.mkdirs();   // boolean mkdir() - создаёт директорию

        File file = new File(path, "cats.txt"); // Создаем файл
